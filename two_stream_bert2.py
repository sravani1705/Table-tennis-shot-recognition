...
parser.add_argument('--dataset', '-d', default='hmdb51',
                    choices=["ucf101", "hmdb51", "tt", "window"],
                    help='dataset: ucf101 | hmdb51 | smtV2')

parser.add_argument('--arch', '-a', default='rgb_slowfast64f_50_bert10_FRMB_early',
                    choices=model_names,
...
def main():
    ...
    if args.dataset=='ucf101':
        ...
        dataset='/media/data/sravani/hmdb51_frames/'
    elif args.dataset=='tt':
        dataset='/media/data/sravani/new_data/'
